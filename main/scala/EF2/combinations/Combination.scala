...
trait Combination {
   ...
   * @see [[EF2.hand.ResolveHand How conflictive combinations are solved in a hand]]
   */
  val priority: Int
   ...
   * @see [[EF2.combinations.straights.ApplyForStraights.applyScore() Special behavior between Straight Combinations and Jokers]]
   */
